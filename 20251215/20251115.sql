...
INSERT INTO dept VALUES (1,'工程部','2023-09-25 09:47:40','2023-09-25 09:47:40'),
						  (2,'人事部','2023-09-25 09:47:40','2023-10-09 15:17:04'),
						  (3,'咨询部','2023-09-25 09:47:40','2023-11-30 21:26:24'),
						  (4,'财务部','2023-09-25 09:47:40','2023-09-25 09:47:40'),
						  (5,'行政部','2023-09-25 09:47:40','2023-09-25 09:47:40'),
                          (6,'法务部','2023-09-25 09:47:40','2023-09-25 09:47:40'),
                          (7,'市场部','2023-09-25 09:47:40','2023-09-25 09:47:40'),
                          (8,'销售部','2023-09-25 09:47:40','2023-09-25 09:47:40'),
                          (9,'研发部','2023-11-30 20:56:37','2023-11-30 20:56:37');
...
create table emp(
    ...
    job tinyint unsigned comment '职位, 1 主管, 2 工程师 , 3 经理, 4 助理, 5 部长',
...
insert into tb_user_card values (1,'汉','1960-11-06','310000100000100001','青浦区公安局','2000-06-10',null,1),
        (2,'汉','1971-11-06','310000100000100002','静安区公安局','2005-06-10','2025-06-10',2),
        (3,'汉','1963-11-06','310000100000100003','长宁区公安局','2006-06-10',null,3),
        (4,'回','1980-11-06','310000100000100004','普陀区公安局','2008-06-10','2028-06-10',4);
...
insert into tb_emp(name, no) values ('张无忌', '2000100101'),('谢逊', '2000100102'),('殷天正', '2000100103'),('韦一笑', '2000100104');


create table tb_project(
   id int auto_increment primary key comment '主键ID',
   name varchar(10) comment '项目名称'
) comment '项目表';
insert into tb_project (name) values ('Haleon'), ('Haleon-WSJ'), ('GEMU') , ('OPPO');


create table tb_emp_project(
   id int auto_increment comment '主键' primary key,
   emp_id int not null comment '员工ID',
   project_id  int not null comment '项目ID',
   constraint fk_projectid foreign key (project_id) references tb_project (id),
   constraint fk_empid foreign key (emp_id) references tb_emp (id)
)comment '员工项目中间表';

insert into tb_emp_project(emp_id, project_id) values (1,1),(1,2),(1,3),(2,2),(2,3),(3,4);